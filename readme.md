...
public static async Task Validate(
        ...
        Func<Type, IEnumerable<IValidator>> validatorFactory)
```
<sup><a href='/src/EfFluentValidation/DbContextValidator.cs#L77-L94' title='File snippet `validatesignature` was extracted from'>snippet source</a> | <a href='#snippet-validatesignature' title='Navigate to start of snippet `validatesignature`'>anchor</a></sup>
<!-- endSnippet -->
